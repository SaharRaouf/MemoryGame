...
<div class="span16">
    ...
    <p><a href="{{URL::to('answers/edit/'.$answer->id)}}" class="btn">Edit</a>
        <a href="{{URL::to('answers/delete/'.$answer->id)}}" class="btn danger" onclick="return confirm('Are you sure?')">Delete</a></p>